...
$\color{red}{isMagicAvailableToUse}$:: This method will use to find the skill with the minimum magic and it will compared with Pokemon's available magic.If the Pokemon's magic is 0 or it is lesser than magic of skill then it will return false.

$\color{red}{showStatus}$: This method shows current status of the pokemon.
