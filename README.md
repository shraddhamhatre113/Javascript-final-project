...
Class has following constructor and methods.
 $\color{cyan}{constructor}$: Constructor is used to initialize health, magic and other characteristics.It also sets skills array to empty and initial capacity of 1000.
